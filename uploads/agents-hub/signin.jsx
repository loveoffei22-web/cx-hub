...
const SHARED_PASSWORD = 'ekedp2026';
...
const AgentsSignin = ({onSubmit}) => {
  ...
  const submit = () => {
    ...
    if (pw !== SHARED_PASSWORD) return setErr('Wrong password. Try again or ask Love.');
    setErr('');
    onSubmit(picked);
  };
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{font:'500 12.5px/1.45 Sora,sans-serif', color:'#475569', marginBottom:14}}>
          Pick your name then enter the team password.
        </div>
        ...
        <div style={{marginBottom:10}}>
          <label style={{display:'block', font:'700 10px/1 Sora,sans-serif', color:'#64748B', letterSpacing:'.6px', textTransform:'uppercase', marginBottom:5}}>Team password</label>
          <div style={{
...
Object.assign(window, {AgentsSignin, SHARED_PASSWORD});
